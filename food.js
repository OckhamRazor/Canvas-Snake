 ...
 ************************************************/
var Food = function (x,y,border,data) {

  this.info = data;
  this.score = 5*data.count; //分数 = 5*贡献数
  this.fillStyle = data.style; //填充样式

  this.x = x || 0;
  this.y = y || 0;
  this.border = border; //参考系
  this.position = new Block(border, x, y, this.fillStyle || '#d6e685');
};
//设置食物块分数
